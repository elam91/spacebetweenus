...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "Space Between Us"
        ...
        self.license = "Elam License"

        #Auhor of program
        self.author_name = "Elam Buteil"
        self.author_email = "elam91@gmail.com"
        self.copyright = "Copyright (c) 2020 Elam Buteil"

        #Description
        self.project_description = "Space Between Us - a game made with pygame and python"

        #Icon file (None will use pygame default icon)
        self.icon_file = 'sbu.bmp'
...
if __name__ == '__main__':
    ...
    a = input("Press any key to continue") #Pause to let user see that things ends